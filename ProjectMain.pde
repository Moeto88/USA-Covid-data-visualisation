DrawMap map;  //created by constantin pusch 4/14
Slider slider;
...
void mousePressed() // created by Saif Ali 15/09/21
{
  int event;
 ...
 //     break;
  ...
  if (mouseX >= 52 && mouseX <= 965 && mouseY >= 203 && mouseY < 788)  // created by Moeto Sonoda 18/4/21
  {
...
void keyPressed() { //created by Constantin Pusch 4/19 to fix bug of map not returning to correct position after entering 3d mode
